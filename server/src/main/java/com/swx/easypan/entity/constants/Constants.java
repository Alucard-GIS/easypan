...
public class Constants {
    ...
    public static final String CHECK_CODE_KEY = "check_code_key"; //登录注册的图形验证码
    public static final String CHECK_CODE_KEY_EMAIL = "check_code_key_email"; //邮箱验证码的图形验证码
    ...
    public static final Integer REDIS_KEY_EXPIRE_ONE_MIN = 60;
    public static final Integer REDIS_KEY_EXPIRE_FIFTEEN_MIN = 15 * 60;
    ...
    public static final String REDIS_KEY_EMAIL_CODE = "easypan:email:code:";
    public static final String REDIS_KEY_EMAIL_CODE_LIMIT = "easypan:email:code:limit:";
