...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
    ...
    public void register(RegisterDTO registerDto) {
        ...
        SysSettingsDTO sysSettingDto = sysSettingsService.getSysSettings();
        userInfo.setTotalSpace(sysSettingDto.getUserInitSpace() * 1024L * Constants.MB);
        this.save(userInfo);
    }
